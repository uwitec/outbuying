...
class Pft_Util_Array{
	 ...
	 * @return string XML
	 */
	public static function varToXml( $var, $key="PftData", $depth = 0 )
	{
		//增加空格,格式化显示
...
//						//Pft_Debug::addInfoToDefault(__FILE__.__LINE__, " get request $key");
//					}
//					$xml .= str_repeat("\t", $depth)."</".get_class($val).">\n";
//				}
//				else
