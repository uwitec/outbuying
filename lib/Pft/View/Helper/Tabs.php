...
class Pft_View_Helper_Tabs
{
	 ...
	 * );
	 * 
	 * Pft_View_Helper_Tabs::build( $main_tabs_arr );
	 * </code>
	 * 
	 */
...
//			else
			...
			$out .= "<td nowrap=\"nowrap\" class=\"".$tabs_css
			      ...
			      . "'\" onmousedown=\"this.className='tabs'\">".Pft_I18n::trans($tabs_info)."</td>";
		}
		$out .= ("</tr></table>");
		$out .= ("</td></tr></table>");
		if( $show ) echo $out;
...
//			else
		...
		$out .= ("</tr></table>");
		$out .= ("</td><td align='right' style='cursor:pointer'><span onclick='huifushanchu();'>".Pft_I18n::trans('RES_ZIYUAN_HUIFUJINYONG')."</span></td></tr></table>");
		if( $show ) echo $out;
		return $out;
	}	
}