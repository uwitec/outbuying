...
class Pft_View_Helper_DateSelector extends Zend_View_Helper_FormElement
{
	...
	{
		$this->_calendar_lib_path = Pft_Config::getSiteRoot().'js/john/jscalendar/';
		$this->_calendar_lib_path_new = Pft_Config::getSiteRoot().'js/calendar/';
		$this->_calendar_theme_file = "calendar-win2k-cold-1";	//不要带.css
		
		//$this->_calendar_lib_path = Pft_Config::getSiteRoot().'js/calendar/';
		//$this->_calendar_lib_path_new = Pft_Config::getSiteRoot().'js/calendar/';
		//$this->_calendar_theme_file = "calendar-win2k-cold-1";	//不要带.css
...
EOT;*/
	...
	private function _getCommonHtml()
	{
		...
		if( !self::$_isBuildedCommonJs ){
			...
			/*
			if (Pft_Session::getSession()->getlanguage() == 'en')
			{	
