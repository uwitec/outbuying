 ...
 * 使用方式如下
 * <code>
 * Watt_Debug::addInfo( basename(__FILE__), "testDebugInfo");
 * </code>
 *                      Source               信息
 * @author Terry
 * @package Watt
...
class Watt_Debug{
	...
	public static function addInfoToDefault( $source="", $info="" )
	{
		...
		//Watt_Log::addLog($info, Watt_Log::LEVEL_DEBUG);		
	}	
...
//				$lastTime = $info[0];
			...
			//print"<pre>Terry :";var_dump( get_included_files() );print"</pre>";
			print"<pre>Terry at ".__FILE__.'(Line:'.__LINE__."):\n";print_r( get_included_files() );print"</pre>";
			//echo "</pre>";
		}
	}
