...
class Watt_Util_Grid_Db
{
	...
	private function language_type()
	{
		...
		'高级检索'		=>	Watt_I18n::trans( 'DBGRID_GAOJIJIANSUO' ),
		'首页'			=>	Watt_I18n::trans( 'DBGRID_SHOUYE' ),
		'上一页'		=>	Watt_I18n::trans( 'DBGRID_SHANGYIYE' ),
		'下一页'		=>	Watt_I18n::trans( 'DBGRID_XIAYIYE' ),
		'尾页'			=>	Watt_I18n::trans( 'DBGRID_WEIYE' ),
		'页'			=>	Watt_I18n::trans( 'DBGRID_YE' ),
		'共'			=>	Watt_I18n::trans( 'DBGRID_GONG' ),
		'项'			=>	Watt_I18n::trans( 'DBGRID_XIANG' ),
		'跳转到'		=>	Watt_I18n::trans( 'DBGRID_TIAOZHUANDAO' ),
		'每页'			=>	Watt_I18n::trans( 'DBGRID_MEIYE' ),
		'返回初始状态'	=>	Watt_I18n::trans( 'DBGRID_CHUSHI' ),
		'隐藏检索'		=>	Watt_I18n::trans( 'DBGRID_YCJIANSUO' ),
		'精确查询'		=>	Watt_I18n::trans( 'DBGRID_JQCHAXUN' ),
		'关联查询'		=>	Watt_I18n::trans( 'DBGRID_GLCHAXUN' ),
		'检索时间格式'	=>	Watt_I18n::trans( 'DBGRID_JSSHIJIANGESHI' ),
		'检索'			=>	Watt_I18n::trans( 'DBGRID_JIANSUO' ),
		'从'			=>	Watt_I18n::trans( 'DBGRID_CONG' ),
		'到'			=>	Watt_I18n::trans( 'DBGRID_DAO' ),
		'小计'			=>	Watt_I18n::trans( '小计' ),
		'合计'			=>	Watt_I18n::trans( '合计' )
		);
		/*$this	->	 z_language		=	array(
		'高级检索'		=>	'高级检索',
		'首页'			=>	'首页',
	...
	private function totList($getdata)
	{
		...
		if ($this->xs_heji)
		{
			...
			//$retudb=Watt_Db::getDb()->getAll($this -> combination(array("LIMIT")));
	 ...
	 * @author john
	 * @version 0.0.0
	 * @time Wed Jan 30 09:17:31 CST 2008
	 **/
	public function getallshuju()
	{
		$all	=	$this	->	GetAll ($this -> combination(array("LIMIT")));
		return $all;
	}
	//修改页数
	...
	*/
	...
	private function html_page()
	{
		...
		$biti.=$this -> link_page['now_num_num']."&nbsp;&nbsp;&nbsp;&nbsp;
			...
			</td><td width=70 nowrap><input class=\"Input1\"  type=\"text\" name=\"nowpg\" size=\"1\" value=\"".$this -> link_page['当前页']."\">&nbsp;</td></tr></table></td></tr>";
	...
	private function html_title()
	{
		...
		foreach ($this -> html_title[name] as $key => $var)
		{
			...
			if ($this -> html_title[linkadd][$key])
			{
				$html_title .= "<th ".$th_width."><a onclick=\"\" href=\"".$this -> html_title[linkadd][$key]."\">".$var."</a></th>";
			}
			else
			{
